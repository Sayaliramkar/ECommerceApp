      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1 flex flex-col-reverse gap-3 sm:flex-row'>
          ...
          <div className='w-full sm:w-[80%]'>
            <img className='w-fulll h-auto' src={image} alt='' />
          </div>
        </div>
        ...
        <div className='flex-1'>
          ...
          <button onClick={()=>addToCart(productData._id,size)} className='bg-black text-white active:bg-gray-700 px-8 py-3 text:sm'>ADD TO CART</button>
